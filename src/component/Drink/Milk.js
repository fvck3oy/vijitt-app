...
export default class Milk extends Component {
	state = { menu_name: '', menu_value: 0, remark: '', price: 160 }
	componentDidMount = () => {
				...
				<Row className="p-3">
					<Col md={4}>
						<Card className="m-2 each-food">
							<div>
								<CardImg top width="100%" src={milk_shake} alt="Card image cap" />
							</div>
						</Card>
					</Col>
					<Col md={8}>
						<div className="d-flex detail-each-menu">
							<div style={{ fontWeight: 'bold', fontSize: 24 }}>Milk Shake 奶昔</div>
							<div>
								<div className="d-flex bd-highlight mt-2 mb-2">
									<div className="d-flex mr-auto p-2 bd-highlight align-items-center">Banana</div>
									<div className="d-flex p-2 bd-highlight  align-items-center">THB 160</div>
								</div>
